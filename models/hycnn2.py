...
class HyCnn(nn.Module):
    def __init__(self):
        super().__init__()
        self.conv3d1 = nn.Conv2d(200, 256, kernel_size=(3, 3), padding=(1, 1))
        self.relu1 = nn.ReLU()
        self.conv3d2 = nn.Conv2d(256, 256, kernel_size=(3, 3), padding=(1, 1))
        self.relu2 = nn.ReLU()
        self.conv3d3 = nn.Conv2d(256, 512, kernel_size=(3, 3), padding=(0, 0))
        self.relu3 = nn.ReLU()
        self.conv2d1 = nn.Conv2d(512, 4096, kernel_size=(3, 3), padding=(0,0))
        self.relu4 = nn.ReLU()
